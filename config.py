...
cfg = {
    'broker_ip': '192.168.0.254',
    'client_id': hexlify(machine.unique_id()),
    'mac': hexlify(WLAN().config('mac')),
    'last_message': 0,
    'message_interval': 5,
    'counter': 0,
    'wlan_ssid': 'ArmyDep',  # 懈屑械薪邪 写谢懈薪薪褘械, 蟹邪褌芯 褌芯褔薪芯 胁褋械 锌芯薪褟褌薪芯
...
pins = {
    ...
    'STR': machine.Pin(14, machine.Pin.OUT),  # 褋懈褉械薪邪 薪邪 泻褉邪褋薪芯屑 锌懈薪械
    'LGT': machine.Pin(4, machine.Pin.OUT)  # 斜械谢褘泄 褋胁械褌 薪邪 蟹械谢械薪芯屑 锌懈薪械
}
